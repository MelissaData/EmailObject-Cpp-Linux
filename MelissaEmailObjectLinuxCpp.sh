...
# Name:    MelissaEmailObjectLinuxCpp
# Purpose: Use the MelissaUpdater to make the MelissaEmailObjectLinuxCpp code usable
...
CurrentPath=$(pwd)
ProjectPath="$CurrentPath/MelissaEmailObjectLinuxCpp"
...
Config_FileName1="libmdEmail.so"
